...
exports.AudioHeader = AudioHeader;
 ...
 * @returns {number}
 */
function classify_frame(buf) {
    const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.classify_frame(ptr0, len0);
    return ret;
}
exports.classify_frame = classify_frame;
 ...
 * @returns {Uint8Array}
 */
function encode_audio_frame(codec_type, sequence, sample_rate, channels, bits_per_sample, timestamp_ms, pcm) {
...
exports.encode_audio_frame = encode_audio_frame;
 ...
 * @returns {Uint8Array}
 */
function encode_frame_prefix(header) {
...
exports.encode_frame_prefix = encode_frame_prefix;
 ...
 * @returns {Uint8Array}
 */
function encode_video_frame(sequence, width, height, quality, timestamp_ms, jpeg) {
...
exports.encode_video_frame = encode_video_frame;
 ...
 * @returns {Uint8Array}
 */
function extract_audio_payload(buf) {
    const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.extract_audio_payload = extract_audio_payload;
 ...
 * @returns {Uint8Array}
 */
function extract_video_payload(buf) {
    const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.extract_video_payload = extract_video_payload;
 ...
 * @returns {boolean}
 */
function is_audio_frame(buf) {
    const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.is_audio_frame(ptr0, len0);
    return ret !== 0;
}
exports.is_audio_frame = is_audio_frame;
 ...
 * @returns {boolean}
 */
function is_video_frame(buf) {
    const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.is_video_frame(ptr0, len0);
    return ret !== 0;
}
exports.is_video_frame = is_video_frame;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./frame_relay_wasm_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/frame_relay_wasm_bg.wasm`;
