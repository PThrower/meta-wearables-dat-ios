...
This document was written against the codebase on `feat/telemetry-diagnostics` at commit `33ea802`. Server resource usage is based on analysis of `relay/server/src/server.ts`. Hetzner pricing as of 2026-04-03. Depends on:
