...
export type WorkflowNodeType = "camera-source" | "phone-mic-source" | "glasses-mic-source" | "gesture-source" | "text" | "s2s-live" | "s2s-rest" | "s2s-e4b" | "jepa-vision" | "jepa-trigger" | "timer-trigger" | "conditional" | "local-tts" | "tones" | "phone-speaker" | "glasses-speaker" | "overlays";
