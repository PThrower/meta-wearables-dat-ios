...
export type WorkflowNodeType = "stream-input" | "text" | "s2s-live" | "s2s-rest" | "s2s-e4b" | "jepa-vision" | "output" | "tts" | "tones" | "phone-speaker" | "glasses-speaker" | "viewers" | "overlays" | "recording";
