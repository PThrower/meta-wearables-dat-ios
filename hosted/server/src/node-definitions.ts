...
export const NODE_DEFINITIONS: NodeDefinition[] = [
...

  {
    ...
    defaultConfig: { modelId: "yolo11n", modelUrl: "", confidence: 0.25, iouThreshold: 0.45, targetFPS: 10, maxDetections: 100, inputSize: 640, smoothingAlpha: 0.3 },
  ...
  },
  {
    ...
    defaultConfig: { modelId: "yolo11n-seg", modelUrl: "", confidence: 0.25, iouThreshold: 0.45, targetFPS: 10, maxDetections: 100, inputSize: 640, smoothingAlpha: 0.3 },
  ...
  },
  {
    ...
    defaultConfig: { modelId: "yolo11n-pose", modelUrl: "", confidence: 0.25, iouThreshold: 0.45, targetFPS: 10, maxDetections: 100, inputSize: 640, smoothingAlpha: 0.3 },
