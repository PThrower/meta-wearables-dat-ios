...
export const NODE_DEFINITIONS: NodeDefinition[] = [
...

  {
    ...
    allowedTargets: ["s2s-live", "s2s-rest", "s2s-e4b", "jepa-vision", "local-tts", "overlays", "gate-mahalanobis", "gate-iou", "gate-bhattacharyya", "gate-reid", "cost-iou", "yolo-detect", "yolo-segment", "yolo-pose", "<sink>", "<trigger>"],
    role: "processor",
    activationMode: "yolo",
    binding: null,
    defaultModel: null,
