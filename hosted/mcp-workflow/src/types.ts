...
export type ActivationMode =
  | "ai" | "jepa" | "stt" | "passthrough" | "vision" | "enhance"
  | "sensor" | "speech" | "tracking" | "measure" | "palantir" | "yolo" | "gating"
  | null;
...
export type ConfigFieldSchema =
  ...
  | { kind: "conditional"; condition: Record<string, unknown>; fields: ConfigFieldSchema[] };
