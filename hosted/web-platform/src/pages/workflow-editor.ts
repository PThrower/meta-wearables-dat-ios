  ...
  if (isNew) {
    ...
    _workflow = {
      ...
      nodes: [
        ...
        { id: `n_local-tts_${now}`, type: "local-tts", label: "Local TTS", config: {}, positionX: 600, positionY: 130 },
        { id: `n_psp_${now}`, type: "phone-speaker", label: "Phone Speaker", config: {}, positionX: 850, positionY: 80 },
        { id: `n_gsp_${now}`, type: "glasses-speaker", label: "Glasses Speaker", config: { profile: "hfp" }, positionX: 850, positionY: 180 },
        { id: `n_ovl_${now}`, type: "overlays", label: "Overlays", config: {}, positionX: 600, positionY: 330 },
      ],
      edges: [
        ...
        { id: `e_4_${now}`, sourceNodeId: `n_local-tts_${now}`, targetNodeId: `n_psp_${now}` },
        { id: `e_5_${now}`, sourceNodeId: `n_local-tts_${now}`, targetNodeId: `n_gsp_${now}` },
        { id: `e_6_${now}`, sourceNodeId: `n_ai_${now}`, targetNodeId: `n_ovl_${now}` },
      ],
