  ...
  if (isNew) {
    ...
    _workflow = {
      ...
      nodes: [
        ...
        { id: `n_psp_${now}`, type: "phone-speaker", label: "Phone Speaker", config: {}, positionX: 660, positionY: 140 },
        { id: `n_gsp_${now}`, type: "glasses-speaker", label: "Glasses Speaker", config: { profile: "hfp" }, positionX: 660, positionY: 270 },
      ],
      edges: [
