import{s as z,p as c,q as te,e as v,n as se,r as B,t as T,u as G,v as ne,x as q,y as ie,z as ae,A as oe,B as re,C as y,D as le,E as X,F as ce,G as de,H as A,I as fe,J as ue,K as pe,L as O,M as we,N as C,O as ve,P,Q as j,R as F,S as R,T as M,U as be,V as ge,g as ye,a as me,W as Se,X as x,Y as he,Z as ke,_ as V,$ as H,a0 as Le,a1 as $e,a2 as _e,a3 as J,a4 as Y,a5 as Ee,a6 as Ie,a7 as qe,a8 as xe,a9 as Te,aa as Ae,ab as Pe,ac as Me,ad as Ne}from"./main-DlERVpKK.js";import"./modulepreload-polyfill-B5Qt9EMX.js";async function We(){var r;const e=c();e&&(e.innerHTML=`
  ...
  `,Oe(),Ce(),Z(),He(a,l.id),Q()}function De(){return[{role:"source",label:"Source"},{role:"reference",label:"Reference"},{role:"processor",label:"Processor"},{role:"trigger",label:"Trigger"},{role:"transform",label:"Transform"},{role:"sink",label:"Sink"}].map(({role:r,label:l})=>{const a=le().filter(i=>i.role===r);return a.length===0?"":`
