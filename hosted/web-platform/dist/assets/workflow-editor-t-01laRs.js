import{e as p,m as W,n as H,l as G,p as M,u as q,q as R,a as U,r as j}from"./main-Cc8g3gSL.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const se={init(i){o=i,K()},destroy(){I&&(clearInterval(I),I=null),document.removeEventListener("keydown",F),o=null,m=!1,t=null,b=null,x=0,N=0,g=1,y=null,v=null}};let o=null,I=null,t=null,m=!1,b=null,y=null,v=null,x=0,N=0,g=1;const A={"camera-source":{fill:"#0d3d38",header:"#14b8a6",stroke:"#14b8a6"},"s2s-live":{fill:"#0d3320",header:"#22c55e",stroke:"#22c55e"},"s2s-rest":{fill:"#0d2040",header:"#3b82f6",stroke:"#3b82f6"},output:{fill:"#3d2000",header:"#f97316",stroke:"#f97316"}},S=180,k=80,T=8;function C(){return`n_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`}function z(){const i=location.hash.slice(1);return i==="/workflows"?"list":i==="/workflows/new"?"new":"edit"}function B(){const e=location.hash.slice(1).match(/^\/workflows\/(.+)$/);return e?e[1]:null}function K(){const i=z();i==="list"?J():O(i==="new")}async function J(){var i;o&&(o.innerHTML=`
