import{d as y,a as g,e as o,c as u}from"./api-client-CzRKcnHI.js";import"./main-DLcfjzgZ.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const E={init(a){a.innerHTML=`
  ...
  `}function m(a,l,e){const i=a.querySelector("#devices-grid");let d=l;if(f==="online"?d=d.filter(s=>s.online):f==="offline"&&(d=d.filter(s=>!s.online)),b){const s=b.toLowerCase();d=d.filter(t=>(t.deviceName||t.device_id||"").toLowerCase().includes(s)||(t.deviceModel||t.device_model||"").toLowerCase().includes(s))}if(d.length===0){i.innerHTML=`<p class="empty-state">${l.length===0?"No devices registered":"No devices match filter"}</p>`;return}i.innerHTML=d.map(s=>{const n=e.filter(c=>{var h;return((h=c.device)==null?void 0:h.deviceName)===s.deviceName}).filter(c=>c.live).length;return`
      <div class="device-card" data-device-id="${o(s.device_id)}">
        <div class="device-card-header">
          <span class="device-name">${o(s.deviceName||s.device_id||"Unknown")}</span>
        ...
        <div class="device-card-body">
          <div class="device-meta">
            ...
            <span class="device-meta-value">${o(s.deviceModel||s.device_model||"--")}</span>
          </div>
          ${s.battery!=null?`
            <div class="device-meta">
      ...
      <div class="modal-section">
        ...
        ${t.length>0?`<div class="modal-sessions">${t.slice(0,10).map(n=>`
              <div class="modal-session-row">
                ...
                <span class="modal-session-id">${o(n.sessionId.slice(0,8))}</span>
