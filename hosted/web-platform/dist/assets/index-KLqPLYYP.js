import{s as Y,p as c,q as se,e as v,n as ae,r as j,t as T,u as z,v as ne,x as q,y as ie,z as oe,A as re,B as le,C as x,D as y,E as G,F as ce,G as de,H as P,I as fe,J as ue,K as pe,L as O,M as we,N as C,O as ve,P as R,Q as X,R as F,S as M,T as be,U as ge,V as ye,g as me,a as Se,W as he,X as A,Y as ke,Z as $e,_ as V,$ as H,a0 as Le,a1 as Ee,a2 as Ie,a3 as J,a4 as B,a5 as _e,a6 as qe,a7 as xe,a8 as Ae,a9 as Te,aa as Pe,ab as Me,ac as Ne,ad as De}from"./main-B6Ls5aul.js";import"./modulepreload-polyfill-B5Qt9EMX.js";async function We(){var o;const e=c();e&&(e.innerHTML=`
  ...
  `,Ye(),je(),Q(),Ge(i,l.id),ee(),x()}const He=[{label:"Inputs",accent:"#14b8a6",match:e=>e.role==="source"},{label:"AI",accent:"#22c55e",match:e=>e.activationMode==="ai"||e.activationMode==="jepa"},{label:"Vision",accent:"#8b5cf6",match:e=>e.activationMode==="vision"},{label:"Enhance",accent:"#84cc16",match:e=>e.activationMode==="enhance"},{label:"Audio",accent:"#06b6d4",match:e=>e.activationMode==="speech"||e.activationMode==="stt"},{label:"Sensors",accent:"#06b6d4",match:e=>e.activationMode==="sensor"},{label:"Triggers",accent:"#eab308",match:e=>e.role==="trigger"},{label:"Outputs",accent:"#f97316",match:e=>e.role==="sink"||e.role==="transform"},{label:"Reference",accent:"#94a3b8",match:e=>e.role==="reference"}];function Be(){const e=ye(),o=new Set;return He.map(l=>{const i=e.filter(s=>!o.has(s.type)&&l.match(s));return i.forEach(s=>o.add(s.type)),i.length===0?"":`
