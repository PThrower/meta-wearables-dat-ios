import{e as p,m as V,n as W,l as R,p as F,u as D,q as B,a as G,r as j}from"./main-Bzog1LVW.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const se={init(s){o=s,U()},destroy(){I&&(clearInterval(I),I=null),document.removeEventListener("keydown",O),o=null,w=!1,t=null,m=null,L=0,E=0,g=1,$=null,v=null}};let o=null,I=null,t=null,w=!1,m=null,$=null,v=null,L=0,E=0,g=1;const A={"stream-input":{fill:"#0d3d38",header:"#14b8a6",stroke:"#14b8a6"},text:{fill:"#1a1a2e",header:"#e2e8f0",stroke:"#94a3b8"},"s2s-live":{fill:"#0d3320",header:"#22c55e",stroke:"#22c55e"},"s2s-rest":{fill:"#0d2040",header:"#3b82f6",stroke:"#3b82f6"},"s2s-e4b":{fill:"#2d1050",header:"#a855f7",stroke:"#a855f7"},output:{fill:"#3d2000",header:"#f97316",stroke:"#f97316"}},k=180,S=80,M=8;function P(){return`n_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`}function K(){const s=location.hash.slice(1);return s==="/workflows"?"list":s==="/workflows/new"?"new":"edit"}function z(){const e=location.hash.slice(1).match(/^\/workflows\/(.+)$/);return e?e[1]:null}function U(){const s=K();s==="list"?J():q(s==="new")}async function J(){var s;o&&(o.innerHTML=`
  ...
  `,_()}}function C(){if(!t)return"";const s=t.nodes,e=t.edges,n=s.map(i=>{const a=A[i.type]??A.output,l=i.type==="s2s-live"||i.type==="s2s-rest"||i.type==="s2s-e4b"?(i.config.model??"").slice(0,20):i.type==="text"?(i.config.text??"").slice(0,22)||"Empty":i.type==="output"?Object.entries({viewers:"view",overlays:"overlay",speaker:"speaker",recording:"rec"}).filter(([,f])=>i.config[f]!==!1).map(([f])=>f).join(", ")||"all":i.type==="stream-input"?[i.config.video!==!1?"video":"",i.config.phoneMic!==!1?"phone-mic":"",i.config.glassesMic===!0?"glasses-mic":"",i.config.gestures!==!1?"gestures":""].filter(Boolean).join(", ")||"none":"Live feed",c=m===i.id;return`
      <g class="wf-node" data-id="${i.id}" transform="translate(${i.positionX}, ${i.positionY})">
        ...
        <circle class="wf-port wf-port-out" cx="${k}" cy="${S/2}" r="6" fill="${a.stroke}" stroke="#0a0a0a" stroke-width="2" />
      </g>
    `}).join(""),u=e.map(i=>{const a=s.find(h=>h.id===i.sourceNodeId),l=s.find(h=>h.id===i.targetNodeId);if(!a||!l)return"";const c=a.positionX+k,f=a.positionY+S/2,r=l.positionX,b=l.positionY+S/2,y=(c+r)/2;return`<path class="wf-edge" data-id="${i.id}" d="M ${c} ${f} C ${y} ${f}, ${y} ${b}, ${r} ${b}" fill="none" stroke="#64748b" stroke-width="2" />`}).join("");return`<svg class="wf-canvas-svg" id="wf-svg" viewBox="${L} ${E} ${900/g} ${600/g}" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  ${u}${n}</svg>`}function x(){const s=o==null?void 0:o.querySelector("#wf-canvas-wrap");s&&(s.innerHTML=C(),H())}function _(){var s,e,n,u;H(),o==null||o.querySelectorAll(".wf-palette-item").forEach(d=>{d.addEventListener("click",()=>{if(!t)return;const i=d.dataset.type;if(i==="stream-input"&&t.nodes.some(r=>r.type==="stream-input")||i==="output"&&t.nodes.some(r=>r.type==="output"))return;const a=r=>r==="s2s-live"||r==="s2s-rest"||r==="s2s-e4b";if(a(i)&&t.nodes.some(r=>a(r.type)))return;const l=P(),c=t.nodes.length*30,f=i==="s2s-live"?{model:"gemini-2.5-flash-native-audio-latest"}:i==="s2s-rest"?{model:"gemma-4-27b"}:i==="s2s-e4b"?{model:"gemma-4-e4b-it"}:i==="text"?{text:""}:i==="output"?{viewers:!0,overlays:!0,speaker:!0,recording:!0}:{};t.nodes.push({id:l,type:i,label:{"stream-input":"Stream Input",text:"Text","s2s-live":"S2S Live","s2s-rest":"S2S REST","s2s-e4b":"S2S E4B",output:"Output"}[i]??i.replace(/-/g," "),config:f,positionX:200+c,positionY:150+c}),w=!0,x()})}),(s=o==null?void 0:o.querySelector("#wf-save-btn"))==null||s.addEventListener("click",async()=>{var i,a;if(!t)return;t.name=((i=o==null?void 0:o.querySelector("#wf-name"))==null?void 0:i.value)??t.name,t.description=((a=o==null?void 0:o.querySelector("#wf-desc"))==null?void 0:a.value)??t.description;const d=t.nodes.map(l=>({...l,config:JSON.stringify(l.config)}));if(t.id){const l=await D(t.id,{name:t.name,description:t.description,nodes:d,edges:t.edges,canvasViewport:JSON.stringify({x:L,y:E,zoom:g}),status:"published"});l&&(t=l)}else{const l=await B({name:t.name,description:t.description,nodes:d,edges:t.edges});l&&(t=await D(l.id,{status:"published"})??l,history.replaceState(null,"",`#/workflows/${t.id}`))}w=!1,q(!1)}),(e=o==null?void 0:o.querySelector("#wf-publish-btn"))==null||e.addEventListener("click",async()=>{var l,c;if(!(t!=null&&t.id)||w&&!confirm("You have unsaved changes. Save before publishing?"))return;const i={status:t.status==="published"?"draft":"published"};w&&(t.name=((l=o==null?void 0:o.querySelector("#wf-name"))==null?void 0:l.value)??t.name,t.description=((c=o==null?void 0:o.querySelector("#wf-desc"))==null?void 0:c.value)??t.description,i.name=t.name,i.description=t.description,i.nodes=t.nodes.map(f=>({...f,config:JSON.stringify(f.config)})),i.edges=t.edges);const a=await D(t.id,i);a&&(t=a,w=!1),q(!1)}),(n=o==null?void 0:o.querySelector("#wf-del-btn"))==null||n.addEventListener("click",async()=>{t!=null&&t.id&&confirm("Delete this workflow?")&&(await F(t.id),location.hash="/workflows")}),(u=o==null?void 0:o.querySelector("#wf-activate-btn"))==null||u.addEventListener("click",async()=>{if(!(t!=null&&t.id))return;const i=(await G()).filter(r=>r.live);if(i.length===0){alert("No live sessions available");return}const a=i.map(r=>{var b;return`${r.sessionId.slice(0,8)} (${((b=r.device)==null?void 0:b.deviceName)??"unknown"})`}).join(`
`),l=prompt(`Activate against which session?
${a}`);if(!l)return;const c=i.find(r=>r.sessionId.startsWith(l)||r.sessionId===l);if(!c){alert("Session not found");return}const f=await j(t.id,c.sessionId);alert(f?`Activated! App: ${f.appId}, Status: ${f.status}`:"Activation failed")}),document.addEventListener("keydown",O)}function O(s){if((s.key==="Delete"||s.key==="Backspace")&&m&&t){if(s.target.tagName==="INPUT"||s.target.tagName==="TEXTAREA")return;s.preventDefault();const e=m;t.nodes=t.nodes.filter(n=>n.id!==e),t.edges=t.edges.filter(n=>n.sourceNodeId!==e&&n.targetNodeId!==e),m=null,w=!0,x(),Y()}}function H(){const s=o==null?void 0:o.querySelector("#wf-svg");s&&(s.querySelectorAll(".wf-node").forEach(e=>{e.addEventListener("mousedown",n=>{const u=n,d=e.getAttribute("data-id"),i=u.target;if(i.classList.contains("wf-port-out")){ee(u,d,s);return}m=d,Y(),x(),i.classList.contains("wf-port-in")||Z(u,d)})}),s.querySelectorAll(".wf-edge").forEach(e=>{e.addEventListener("click",()=>{if(!t)return;const n=e.getAttribute("data-id");t.edges=t.edges.filter(u=>u.id!==n),w=!0,x()})}),s.addEventListener("mousedown",e=>{const n=e;(n.target===s||n.target.tagName==="rect")&&(n.button===1||n.ctrlKey||n.metaKey?(e.preventDefault(),n.clientX,n.clientY):(m=null,Y(),x()))}),s.addEventListener("wheel",e=>{e.preventDefault();const u=e.deltaY>0?.9:1.1;g=Math.max(.3,Math.min(3,g*u)),s.setAttribute("viewBox",`${L} ${E} ${900/g} ${600/g}`)},{passive:!1}))}function Q(s,e,n,u){for(const d of n){if(d.sourceNodeId!==e.id&&d.targetNodeId!==e.id)continue;const i=s.querySelector(`[data-id="${d.id}"]`);if(!i)continue;const a=u.find(h=>h.id===d.sourceNodeId),l=u.find(h=>h.id===d.targetNodeId);if(!a||!l)continue;const c=a.positionX+k,f=a.positionY+S/2,r=l.positionX,b=l.positionY+S/2,y=(c+r)/2;i.setAttribute("d",`M ${c} ${f} C ${y} ${f}, ${y} ${b}, ${r} ${b}`)}}function Z(s,e){if(!t)return;const n=t.nodes.find(i=>i.id===e);if(!n)return;$={nodeId:e,startX:s.clientX,startY:s.clientY,nodeStartX:n.positionX,nodeStartY:n.positionY};const u=i=>{if(!$||!t)return;const a=(i.clientX-$.startX)/g,l=(i.clientY-$.startY)/g,c=t.nodes.find(f=>f.id===$.nodeId);if(c){c.positionX=Math.round($.nodeStartX+a),c.positionY=Math.round($.nodeStartY+l),w=!0;const f=o==null?void 0:o.querySelector("#wf-svg"),r=f==null?void 0:f.querySelector(`[data-id="${$.nodeId}"]`);r&&(r.setAttribute("transform",`translate(${c.positionX}, ${c.positionY})`),Q(f,c,t.edges,t.nodes))}},d=()=>{$=null,document.removeEventListener("mousemove",u),document.removeEventListener("mouseup",d),x()};document.addEventListener("mousemove",u),document.addEventListener("mouseup",d)}function ee(s,e,n){const u=t==null?void 0:t.nodes.find(f=>f.id===e);if(!u)return;n.getBoundingClientRect();const d=u.positionX+k,i=u.positionY+S/2,a=document.createElementNS("http://www.w3.org/2000/svg","line");a.setAttribute("x1",String(d)),a.setAttribute("y1",String(i)),a.setAttribute("x2",String(d)),a.setAttribute("y2",String(i)),a.setAttribute("stroke","#94a3b3"),a.setAttribute("stroke-width","2"),a.setAttribute("stroke-dasharray","4"),n.appendChild(a),v={sourceNodeId:e,tempLine:a};const l=f=>{if(!v)return;const r=n.getBoundingClientRect(),b=L+(f.clientX-r.left)/r.width*(900/g),y=E+(f.clientY-r.top)/r.height*(600/g);v.tempLine.setAttribute("x2",String(b)),v.tempLine.setAttribute("y2",String(y))},c=f=>{v!=null&&v.tempLine.parentNode&&v.tempLine.parentNode.removeChild(v.tempLine);const r=n.getBoundingClientRect(),b=L+(f.clientX-r.left)/r.width*(900/g),y=E+(f.clientY-r.top)/r.height*(600/g),h=t==null?void 0:t.nodes.find(N=>b>=N.positionX&&b<=N.positionX+k&&y>=N.positionY&&y<=N.positionY+S&&N.id!==v.sourceNodeId);h&&t&&(t.edges.some(T=>T.sourceNodeId===v.sourceNodeId&&T.targetNodeId===h.id)||(t.edges.push({id:P(),sourceNodeId:v.sourceNodeId,targetNodeId:h.id}),w=!0,x())),v=null,document.removeEventListener("mousemove",l),document.removeEventListener("mouseup",c)};document.addEventListener("mousemove",l),document.addEventListener("mouseup",c)}function Y(){var u;const s=o==null?void 0:o.querySelector("#wf-config-panel");if(!s||!t)return;if(!m){s.innerHTML='<p class="empty-state">Select a node</p>';return}const e=t.nodes.find(d=>d.id===m);if(!e){s.innerHTML='<p class="empty-state">Select a node</p>';return}const n=A[e.type]??A.output;if(e.type==="stream-input"){const d=e.config.visionFps??1,i=e.config.video!==!1,a=e.config.phoneMic!==!1,l=e.config.glassesMic===!0,c=e.config.gestures!==!1;s.innerHTML=`
    ...
    `;else if(e.type==="output"){const d=e.config.viewers!==!1,i=e.config.overlays!==!1,a=e.config.speaker!==!1,l=e.config.recording!==!1;s.innerHTML=`
      ...
      <button class="btn btn-danger btn-sm wf-config-delete" data-id="${e.id}">Delete Node</button>
    `}s.querySelectorAll("[data-field]").forEach(d=>{d.addEventListener("change",()=>{if(!t||!m)return;const i=t.nodes.find(c=>c.id===m);if(!i)return;const a=d.dataset.field,l=d;if(a.startsWith("config.")){const c=a.slice(7);l.type==="range"?i.config[c]=parseFloat(l.value):l.type==="checkbox"?i.config[c]=l.checked:i.config[c]=l.value}else i[a]=l.value;w=!0,x()})}),(u=s.querySelector(".wf-config-delete"))==null||u.addEventListener("click",()=>{if(!t)return;const d=s.querySelector(".wf-config-delete").dataset.id;t.nodes=t.nodes.filter(i=>i.id!==d),t.edges=t.edges.filter(i=>i.sourceNodeId!==d&&i.targetNodeId!==d),m=null,w=!0,x(),Y()})}export{se as default,se as page};
